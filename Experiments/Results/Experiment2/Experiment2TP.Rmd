...
t.test(A1A12$responseR1, train$responseR1[train$blockNr == "Block1" & train$Trial == 15], alternative = "two.sided", paired = FALSE) #no diff
t.test(B1A12$responseR1, train$responseR2[train$blockNr == "Block1" & train$Trial == 16], alternative = "two.sided", paired = FALSE) #diff, increase
t.test(X1A12$responseR2, train$responseR3[train$blockNr == "Block1" & train$Trial == 16], alternative = "two.sided", paired = FALSE) #diff, increase


#2) Are there sign differences between A, B and X when asked in block 3 and in the test phase
t.test(A3A12$responseR1, train$responseR1[train$blockNr == "Block3" & train$Trial == 15], alternative = "two.sided", paired = FALSE) #no diff
t.test(B3A12$responseR1, train$responseR2[train$blockNr == "Block3" & train$Trial == 16], alternative = "two.sided", paired = FALSE) #no diff
t.test(X3A12$responseR2, train$responseR3[train$blockNr == "Block3" & train$Trial == 16], alternative = "two.sided", paired = FALSE) #diff, increase
...
t.test(CA12$responseR1, A3A12$responseR1, alternative = "two.sided", paired = FALSE) #diff, lower C
t.test(CA12$responseR1, B3A12$responseR1, alternative = "two.sided", paired = FALSE) #no sign diff
t.test(CA12$responseR1, X3A12$responseR2, alternative = "two.sided", paired = FALSE) #diff, lower C


t.test(CA12$responseR1, A1A12$responseR1, alternative = "two.sided", paired = FALSE) #diff lower C
t.test(CA12$responseR1, B1A12$responseR1, alternative = "two.sided", paired = FALSE) #diff lower C
t.test(CA12$responseR1, X1A12$responseR2, alternative = "two.sided", paired = FALSE) #diff lower C
```

```{r}
#4) Is there a difference between the ratings to fossil and those to diamond?
t.test(A1A12$responseR1, A1F12$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(B1A12$responseR1, B1F12$responseR1, alternative = "two.sided", paired = FALSE) #no diff (marginal)
t.test(X1A12$responseR2, X1F12$responseR2, alternative = "two.sided", paired = FALSE) #sign, fossil lower
t.test(CA12$responseR1, CF12$responseR1, alternative = "two.sided", paired = FALSE)   #no sign (makes sense! The cue is new)
t.test(A3A12$responseR1, A3F12$responseR1, alternative = "two.sided", paired = FALSE) #sign, fossil lower
t.test(B3A12$responseR1, B3F12$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(X3A12$responseR2, X3F12$responseR2, alternative = "two.sided", paired = FALSE) #sign, fossil lower
```
...
```{r}
t.test(A1A12000$responseR1, A1A12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff 
t.test(A1A12050$responseR1, A1A12100$responseR1, alternative = "two.sided", paired = FALSE) #diff, 100-0 higher than 75-25
t.test(A1A12100$responseR1, A1A12000$responseR1, alternative = "two.sided", paired = FALSE) #diff, 100-0 higher than 50-50

t.test(B1A12000$responseR1, B1A12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff 
t.test(B1A12050$responseR1, B1A12100$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(B1A12100$responseR1, B1A12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff

t.test(X1A12000$responseR2, X1A12050$responseR2, alternative = "two.sided", paired = FALSE) #no diff 
t.test(X1A12050$responseR2, X1A12100$responseR2, alternative = "two.sided", paired = FALSE) #no diff
t.test(X1A12100$responseR2, X1A12000$responseR2, alternative = "two.sided", paired = FALSE) #no diff
```
```{r}
t.test(A3A12000$responseR1, A3A12050$responseR1, alternative = "two.sided", paired = FALSE) #diff, 50-50 higher than 75-25 (weird) 
t.test(A3A12050$responseR1, A3A12100$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(A3A12100$responseR1, A3A12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff

t.test(B3A12000$responseR1, B3A12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(B3A12050$responseR1, B3A12100$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(B3A12100$responseR1, B3A12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff

t.test(X3A12000$responseR2, X3A12050$responseR2, alternative = "two.sided", paired = FALSE) #no diff
t.test(X3A12050$responseR2, X3A12100$responseR2, alternative = "two.sided", paired = FALSE) #diff, 75-25 higher than 100-0 
t.test(X3A12100$responseR2, X3A12000$responseR2, alternative = "two.sided", paired = FALSE) #no diff
```
...
```{r}
#1) Are there significant differences between A, B and X when asked in their original block 1 and in the test phase
t.test(A1A12000$responseR1, (train$responseR1[train$Cond == "0" & train$Trial == 15 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #no diff
t.test(A1A12050$responseR1, (train$responseR1[train$Cond == "50" & train$Trial == 15 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #no diff
t.test(A1A12100$responseR1, (train$responseR1[train$Cond == "100" & train$Trial == 15 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #no diff (marginally)

t.test(B1A12000$responseR1, (train$responseR2[train$Cond == "0" & train$Trial == 16 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #no diff
t.test(B1A12050$responseR1, (train$responseR2[train$Cond == "50" & train$Trial == 16 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #diff, test higher than train
t.test(B1A12100$responseR1, (train$responseR2[train$Cond == "100" & train$Trial == 16 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #diff, test higher than train

t.test(X1A12000$responseR2, (train$responseR3[train$Cond == "0" & train$Trial == 16 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #diff, test higher than train
t.test(X1A12050$responseR2, (train$responseR3[train$Cond == "50" & train$Trial == 16 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #no diff
t.test(X1A12100$responseR2, (train$responseR3[train$Cond == "100" & train$Trial == 16 & train$blockNr == "Block1"]), alternative = "two.sided", paired = FALSE) #diff, test higher than train

#2) Are there sign differences between A, B and X when asked in block 3 and in the test phase
t.test(A3A12000$responseR1, (train$responseR1[train$Cond == "0" & train$Trial == 15 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #no diff
t.test(A3A12050$responseR1, (train$responseR1[train$Cond == "50" & train$Trial == 15 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #diff, test LOWER than train
t.test(A3A12100$responseR1, (train$responseR1[train$Cond == "100" & train$Trial == 15 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #no diff 

t.test(B3A12000$responseR1, (train$responseR2[train$Cond == "0" & train$Trial == 16 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #no diff
t.test(B3A12050$responseR1, (train$responseR2[train$Cond == "50" & train$Trial == 16 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #no diff
t.test(B3A12100$responseR1, (train$responseR2[train$Cond == "100" & train$Trial == 16 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #no diff

t.test(X3A12000$responseR2, (train$responseR3[train$Cond == "0" & train$Trial == 16 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #no diff
t.test(X3A12050$responseR2, (train$responseR3[train$Cond == "50" & train$Trial == 16 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #diff, test higher than train
t.test(X3A12100$responseR2, (train$responseR3[train$Cond == "100" & train$Trial == 16 & train$blockNr == "Block3"]), alternative = "two.sided", paired = FALSE) #diff, test higher than train
```


```{r}
#3) Is there a sign difference between the C value and that of A B and X in the test phase 
t.test(CA12$responseR1, A1A12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(CA12$responseR1, A1A12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(CA12$responseR1, A1A12100$responseR1, alternative = "two.sided", paired = FALSE) #diff, C lower

t.test(CA12$responseR1, B1A12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(CA12$responseR1, B1A12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff (marginally)
t.test(CA12$responseR1, B1A12100$responseR1, alternative = "two.sided", paired = FALSE) #diff, C lower

t.test(CA12$responseR1, X1A12000$responseR2, alternative = "two.sided", paired = FALSE) #diff, C lower
t.test(CA12$responseR1, X1A12050$responseR2, alternative = "two.sided", paired = FALSE) #diff, C lower
t.test(CA12$responseR1, X1A12100$responseR2, alternative = "two.sided", paired = FALSE) #diff, C lower

t.test(CA12$responseR1, A3A12000$responseR1, alternative = "two.sided", paired = FALSE) #diff, C lower
t.test(CA12$responseR1, A3A12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(CA12$responseR1, A3A12100$responseR1, alternative = "two.sided", paired = FALSE) #no diff (but a very high diff in means, so maybe small sample size is an issue)

t.test(CA12$responseR1, B3A12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(CA12$responseR1, B3A12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(CA12$responseR1, B3A12100$responseR1, alternative = "two.sided", paired = FALSE) #no diff

t.test(CA12$responseR1, X3A12000$responseR2, alternative = "two.sided", paired = FALSE) #diff, C lower
t.test(CA12$responseR1, X3A12050$responseR2, alternative = "two.sided", paired = FALSE) #diff, C lower
t.test(CA12$responseR1, X3A12100$responseR2, alternative = "two.sided", paired = FALSE) #no diff
```


```{r}
#4) Is there a difference between the ratings to fossil and those to diamond?
t.test(A1A12000$responseR1, A1F12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(A1A12050$responseR1, A1F12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(A1A12100$responseR1, A1F12100$responseR1, alternative = "two.sided", paired = FALSE) #diff, fossil lower

t.test(B1A12000$responseR1, B1F12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(B1A12050$responseR1, B1F12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(B1A12100$responseR1, B1F12100$responseR1, alternative = "two.sided", paired = FALSE) #no diff

t.test(X1A12000$responseR2, X1F12000$responseR2, alternative = "two.sided", paired = FALSE) #no diff
t.test(X1A12050$responseR2, X1F12050$responseR2, alternative = "two.sided", paired = FALSE) #no diff
t.test(X1A12100$responseR2, X1F12100$responseR2, alternative = "two.sided", paired = FALSE) #diff, fossil lower

t.test(A3A12000$responseR1, A3F12000$responseR1, alternative = "two.sided", paired = FALSE) #diff, fossil lower
t.test(A3A12050$responseR1, A3F12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(A3A12100$responseR1, A3F12100$responseR1, alternative = "two.sided", paired = FALSE) #no diff

t.test(B3A12000$responseR1, B3F12000$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(B3A12050$responseR1, B3F12050$responseR1, alternative = "two.sided", paired = FALSE) #no diff
t.test(B3A12100$responseR1, B3F12100$responseR1, alternative = "two.sided", paired = FALSE) #no diff

t.test(X3A12000$responseR2, X3F12000$responseR2, alternative = "two.sided", paired = FALSE) #diff, fossil lower
t.test(X3A12050$responseR2, X3F12050$responseR2, alternative = "two.sided", paired = FALSE) #no diff
t.test(X3A12100$responseR2, X3F12100$responseR2, alternative = "two.sided", paired = FALSE) #no diff
```
