...
#Do I want a randomized cue for each condition? For each cue? or just a randomized cue in general?


Cue <- c("A_X", "B_X", "B_X", "A_X", "A_X", "B_X", "A_X", "B_X", "B_X", "A_X", "B_X", "A_X", "A_X", "B_X", "A_X", "B_X")
Cue <- paste("env", Cue, sep = "_")
randCue000 <- sample(Cue)
randCue050 <- sample(Cue)
randCue100 <- sample(Cue)
#However how on earth could I match the outcome to this? Especially since there's an order to it, otherwise the conditions are void as well
